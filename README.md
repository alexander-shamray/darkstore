...
> Подробная декомпозиция MVP по вехам M0–M5 — в [`docs/MVP_PLAN.md`](docs/MVP_PLAN.md). Канонический график сроков (Optimistic vs Realistic) — там же. Таблица ниже синхронизирована с источником правды.

| Веха | 🟢 Optimistic | 🟡 Realistic |
|------|---------------|--------------|
| Backend MVP готов (M3) | конец августа 2026 (мес. 4) | середина октября 2026 (мес. 5.5) |
| Closed Beta — 50+ пользователей (M4) | конец сентября 2026 (мес. 5) | конец ноября 2026 (мес. 7) |
| Публичный запуск — soft launch (M5) | конец октября 2026 (мес. 6) | конец декабря 2026 (мес. 8) |
| 1 000 заказов в месяц | конец января 2027 (мес. 9) | конец марта 2027 (мес. 11) |
| Готовность к масштабированию | конец апреля 2027 (мес. 12) | конец июня 2027 (мес. 14) |

**Итого MVP:** 6 месяцев Optimistic / 8 месяцев Realistic.
