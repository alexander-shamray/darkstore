...
| 6.2 | [MVP_PLAN.md](./MVP_PLAN.md) | Пошаговый план MVP по вехам M0–M5: операционные требования к каждой вехе, KPI (время сборки/доставки, NPS), gate публичного запуска (юр-готовность, ОФД, склад, поддержка) |
