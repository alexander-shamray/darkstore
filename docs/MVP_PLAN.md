...
**Период MVP (Optimistic):** Май 2026 — Октябрь 2026 (6 месяцев)
**Период MVP (Realistic):** Май 2026 — Декабрь 2026 (8 месяцев)
...
> Гант ниже показывает **happy path (Optimistic)** — последовательное закрытие 6 вех по 30 дней. Двухтрековый план с буфером — в [Каноническом графике вех](#канонический-график-вех-источник-правды) ниже.

```mermaid
gantt
    title Dark Store — Вехи MVP (Optimistic, Май–Октябрь 2026)
...
### Канонический график вех (источник правды)

> Все остальные документы (`ROADMAP_12_MONTHS`, `README`, `FINANCIAL_MODEL`, `index`) ссылаются на эту таблицу. При изменении сроков обновляется **только** эта таблица + краткая ссылка в зависимых файлах.

| Веха | 🟢 Optimistic | 🟡 Realistic | Главный итог |
|------|---------------|--------------|--------------|
| **M0 — Фундамент** | конец мая 2026 | конец мая 2026 | Деплой пустого API в Azure через CI/CD |
| **M1 — Каталог и Auth** | конец июня 2026 | середина июля 2026 | Пользователь регистрируется и видит каталог |
| **M2 — Заказ и оплата** | конец июля 2026 | конец августа 2026 | Заказ оплачен через Kaspi Pay (тестовый стенд) |
| **M3 — Backend MVP** | конец августа 2026 | середина октября 2026 | 1С интеграция + минимальный Angular shell |
| **M4 — Closed Beta** | конец сентября 2026 | конец ноября 2026 | 50+ тестировщиков делают реальные заказы |
| **M5 — Public Launch** | конец октября 2026 | конец декабря 2026 | Soft launch, первый платный оборот |
| **🏁 ИТОГО** | **6 месяцев** | **8 месяцев** | от старта M0 до публичного запуска |

**Что закладывает буфер реалистичного сценария (+2 месяца):**

- **M1 (+2 нед):** первое разделение `AppDbContext` / `PersonalDataDbContext`, ожидание SMS OTP провайдера.
- **M2 (+1 мес):** доступ к Kaspi Pay sandbox, отладка идемпотентности webhook, фискализация (ОФД/ККМ).
- **M3 (+1.5 мес):** документация 1С от партнёра, скорость Angular shell соло-разработчика.
- **M4 (+2 мес):** UX-итерации с реальными picker/courier на складе, KZ Local HA standby, АЗС интеграция.
- **M5:** не сдвигается отдельно — буфер уже накоплен в M1–M4.

**Когда планировать по Optimistic:** при найме Angular-подрядчика в M2 (ускоряет M3–M4), при готовом Kaspi sandbox в M0, при наличии документации 1С на руках в M0.
**Когда планировать по Realistic (по умолчанию):** соло-разработчик, партнёрские API уточняются по ходу, первый запуск операционной команды.

```mermaid
gantt
    title Optimistic vs Realistic — публичный запуск
    dateFormat  YYYY-MM-DD
    axisFormat  %m/%Y

    section Optimistic (6 мес)
    M0–M5 happy path                 :done, opt, 2026-05-01, 180d
    🚀 Soft launch (opt)             :milestone, after opt, 0d

    section Realistic (8 мес)
    M0–M5 с буферами                 :crit, real, 2026-05-01, 240d
    🚀 Soft launch (real)            :milestone, after real, 0d
```
...
**🟢 Optimistic:** конец мая 2026 (4 недели) · **🟡 Realistic:** конец мая 2026 (4 недели)
...
## 🛒 Веха M1 — Каталог и Auth

**🟢 Optimistic:** конец июня 2026 (4 недели) · **🟡 Realistic:** середина июля 2026 (6 недель)
...
## 💳 Веха M2 — Заказ и оплата

**🟢 Optimistic:** конец июля 2026 (4 недели) · **🟡 Realistic:** конец августа 2026 (8 недель)
...
**🟢 Optimistic:** конец августа 2026 (4 недели) · **🟡 Realistic:** середина октября 2026 (10 недель)
...
## 📱 Веха M4 — Operator PWA + Closed Beta

**🟢 Optimistic:** конец сентября 2026 (4 недели) · **🟡 Realistic:** конец ноября 2026 (8 недель)
...
## 🚀 Веха M5 — Public Launch

**🟢 Optimistic:** конец октября 2026 (4 недели) · **🟡 Realistic:** конец декабря 2026 (4 недели после M4)
