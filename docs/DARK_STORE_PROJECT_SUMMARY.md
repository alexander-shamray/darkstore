...
> Канонические сроки MVP по вехам M0–M5 (Optimistic vs Realistic) — в [`MVP_PLAN.md`](./MVP_PLAN.md). Ниже укрупнённый взгляд по этапам.

| Этап | 🟢 Optimistic | 🟡 Realistic | Цель | Ключевые фичи |
|------|---------------|--------------|------|---------------|
| MVP | 6 месяцев (M0→M5) | 8 месяцев (M0→M5) | Запуск минимального продукта | Каталог, корзина, оплата Kaspi, базовая доставка, простая лояльность |
| Рост | +6 месяцев после MVP | +6 месяцев после MVP | Стабильная работа | ИИ-агент, улучшенная складская логика, аналитика |
| Масштаб | 12+ месяцев от старта | 14+ месяцев от старта | Расширение | Несколько дарксторов, мобильное приложение, продвинутый ИИ |
